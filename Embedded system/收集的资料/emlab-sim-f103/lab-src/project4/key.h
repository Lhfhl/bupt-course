...
#endif
#ifdef STM32F10X_MD
#define KEY_PLAY_PIN_NAME     PIN_DEV_PATH"/PC.0"   //K3
#define KEY_NEXT_PIN_NAME     PIN_DEV_PATH"/PC.1"  //K4
#define KEY_LAST_PIN_NAME     PIN_DEV_PATH"/PC.2"  //K5
#define KEY_LIST_PIN_NAME     PIN_DEV_PATH"/PC.3"   //K6
#endif
